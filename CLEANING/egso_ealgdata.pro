...
; NAME              : egso_ealgdata
;
; PURPOSE           : Calculating ellipse from algebraic coefficients
;
; EXPLANATION       : Calculating ellipse from algebraic coefficients
;
;
; CATEGORY          : EGSO_WP5, Fitting an Ellipse
;
; CALLING SEQUENCE  : egso_ealgdata, xc, yc, v, xc1, yc1, R1, R2, theta, [/noprint]
;
;
; INPUT             : xc, yc      coordinate centre pixel coordinates
...
;
;
; KEYWORDS          : noprint     if not set, prints the resulting parameters on the screen
;
; PROCEDURE         :
;
; CALLS             : None
;
; EXAMPLE           : egso_ealgdata, xc, yc, vector, xc1, yc1, R1, R2, theta
;
; SIDE EFFECTS      : None.
;
...
pro egso_ealgdata, xc, yc, v, xc1, yc1, R1, R2, theta, noprint=noprint
